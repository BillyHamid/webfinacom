        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <RevealOnScroll direction="left" className="lg:col-span-5">
            <div className="relative">
              ...
              <div className="relative aspect-[16/10] sm:aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl shadow-primary-900/15 ring-1 ring-white">
              ...
              <div className="absolute -bottom-4 right-2 sm:-bottom-6 sm:-right-6 max-w-[220px] sm:max-w-[280px] bg-white rounded-2xl p-4 sm:p-5 shadow-2xl shadow-primary-900/15 border border-gray-100">
                <Quote
                  size={18}
