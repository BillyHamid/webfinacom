...
export default function Navbar() {
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      const sections = ['hero', 'services', 'about', 'metrics', 'news', 'events', 'quick-access', 'contact'];
  ...
  const navLinks = [
    ...
    { label: 'Événements', href: '#events', id: 'events' },
          ...
          <div className="flex items-center justify-between h-20 lg:h-[72px]">
            ...
            <a href="#hero" className="flex items-center gap-3 group relative z-10">
              ...
              <div className="hidden sm:block">
                ...
                <span className={`block text-[9px] uppercase tracking-[0.25em] -mt-0.5 font-medium transition-colors duration-300 ${
            ...
            <div className="hidden lg:flex items-center gap-2.5">
              <a
                ...
                className={`flex items-center gap-1.5 px-3 py-2 text-[13px] font-medium rounded-lg transition-all duration-300 ${
                  scrolled
                    ? 'text-gray-600 hover:text-primary-600 hover:bg-gray-50'
                    : 'text-white/75 hover:text-white hover:bg-white/10'
                }`}
              >
                <Phone size={14} />
                <span className="hidden xl:inline">+226 25 00 00 00</span>
              </a>
              <a
                href="#quick-access"
              ...
              <a
                href="#contact"
                className="px-5 py-2.5 text-[13px] font-semibold rounded-lg bg-accent-500 text-white hover:bg-accent-600 transition-all duration-300 shadow-lg shadow-accent-500/20 hover:shadow-accent-500/40 hover:-translate-y-px active:translate-y-0"
              >
                Ouvrir un compte
              </a>
            </div>
          ...
          >
            <div className="pt-24 px-6 pb-8 h-full overflow-y-auto">
              ...
              <div className="mt-8 px-4">
                <a href="tel:+22625000000" className="flex items-center gap-2 text-sm text-gray-400">
                  <Phone size={14} />
                  +226 25 00 00 00
                </a>
              </div>
